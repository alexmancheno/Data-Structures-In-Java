...
//        System.out.println("Binary trees are structurally equal (instance version): " + t.compareTrees(tt));
        ...
        int[] array3 = {0, 20, 10, 15, 17, 16, 32, 7, 22};
        int[] array4 = {0, 20, 10, 15, 17, 16};
        ...
        System.out.println("----------------------------");
        System.out.println("MaxHeapPQ tests:");
        MaxHeapPQ<Integer> heap = new MaxHeapPQ<Integer>();

        for (int i = 0; i < array3.length; i++) {
            heap.insert(array3[i]);
        }
